...
export function startScheduler(): void {
  ...
  console.log('✓ Scheduler started (pending-notify */5min, approval-reminders 06:00 UTC, silent-consent 07:00 UTC, cert-check 08:00 UTC, membership-cleanup 09:00 UTC)');
}

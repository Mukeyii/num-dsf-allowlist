...
const STATUS_LABEL_KEY: Record<
  ...
  'mapDetailsCertValid' | 'mapDetailsCertExpiring' | 'mapDetailsCertExpired' | 'mapDetailsCertNone'
> = {
          ...
          >
            <span
              style={{
                ...
                height: '7px',
                borderRadius: '50%',
                background: org.active ? '#10b981' : '#94a3b8',
              }}
            />
          ...
          {(org.cert_status === 'EXPIRING' || org.cert_status === 'EXPIRED') && (
            ...
            >
              ...
              <div
                style={{
                  fontSize: '12px',
                  color: org.cert_status === 'EXPIRED' ? '#b91c1c' : '#9a3412',
                }}
              >
                {t(

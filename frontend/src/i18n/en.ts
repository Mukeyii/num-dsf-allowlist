...
export const en = {
  ...
  marketplaceDsfMetadata: 'DSF metadata',
  marketplaceProcessId: 'Process identifiers',
  marketplaceRequiredRoles: 'Required roles',
  marketplaceMessageNames: 'Message names',
  marketplaceArtifact: 'Plugin artifact',
  marketplaceMetaSource: 'Metadata source',
  marketplaceLifecycleTrust: 'Lifecycle & trust',
  marketplaceAdvisory: 'Advisory',
  marketplaceVersionHistory: 'Version history',
  marketplaceLicenseOk: 'OSI license',
  marketplaceStale: 'Stale',
  marketplaceEditMeta: 'Edit metadata',
  marketplaceNotFound: 'Process not found.',
  marketplaceAdvisorySeverity: 'Advisory severity',
  ...
  totpDigitsRequired: '6 digits required',
  ...
  noOrgConfigured: 'No organization configured',
  statusNoRequest: 'NO REQUEST',
  statusDaysSuffix: 'days',
